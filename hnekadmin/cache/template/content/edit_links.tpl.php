...
<body>
    ...
    <form action="" method="post" class="form-search">
        <input name="links_id" value="<?php echo $info['links_id'];?>" type="hidden">
        <table class="table table-bordered">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="links_url" placeholder="填写完整url地址，包括http://" size="45" value="<?php echo $info['links_url'];?>" />
                    </td>
                </tr>
                <tr>
                    <td align="right"><strong>网站LOGO：</strong></td>
                    <td>
                        <?php if ($info['image']) { ?><img width="30" height="30" src="<?php echo $info['image'];?>"><?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="introduce" placeholder="此信息只对管理员可见，可对该友链添加备注信息"><?php echo $info['introduce'];?></textarea>
                    </td>
                </tr>
            </tbody>
            <tfoot>
