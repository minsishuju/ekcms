    ...
    <body>
        <ul class="breadcrumb">
            ...
            <li class="pull-right" style="margin-top:-3px">
                <a class="btn btn-small btn-primary pull-right" href="index.php?c=Content&a=add&id=<?php echo $category['category_id'];?>">添加内容</a>
            </li>
        </ul>
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <th align='center'><input class="select" value="<?php echo $vo['content_id'];?>" type="checkbox"></th>
                    <td align='center'><span  class="listorders" data-content_id="<?php echo $vo['content_id'];?>"><?php echo $vo['listorder'];?></span></td>
                    <td align='center'><?php echo $vo['content_id'];?></td>
                    ...
                    <td align='center'><?php echo @date('Y-m-d H:i:s',$vo['update_time']);?></td>
                    <td align='center'><?php echo $vo['hits'];?></td>
                    <td align='center'>
                        <a href="index.php?c=Content&a=edit&id=<?php echo $vo['content_id'];?>">修改</a> | 
                        <a href="javascript:void(0)" onclick="return confirmurl('index.php?c=Content&a=delete&id=<?php echo $vo['content_id'];?>','确定删除“<?php echo $vo['title'];?>”吗?')">删除</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
            <tfoot>
                <tr >
                    ...
                    <td colspan="8"><div class="pagination"><?php echo $page;?></div></td>
                </tr>
            </tfoot>
        </table>
