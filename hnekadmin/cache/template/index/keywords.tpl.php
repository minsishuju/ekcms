        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="keyword_category">
                    <?php foreach ($vo['keywords'] as $val) {?>
                    <span class="tags" data-keywords="<?php echo $val['keywords_id'];?>"><font class="edit_tags"><?php echo @iStripslashes($val['name']);?></font><a href="javascript:void(0);" class="delete_tags">×</a></span>
                    <?php } ?>
                    <div class="input-append">
                        <input class="span1" type="text">
                        <button class="btn add_keywords" data-category="<?php echo $vo['category_id'];?>" type="button">确定</button>
                    </div>
                </td>
                <td align='center'>
                    <?php if ($vo['need'] == 1) { ?>是<?php } else { ?>否<?php } ?>
                </td>
                <td align='center'>
                    <a href="javascript:void(0)" class="edit_keywords_category" data-category="<?php echo $vo['category_id'];?>">修改</a>&nbsp;|&nbsp;
                    <a href="javascript:void(0)" onclick="return confirmurl('index.php?c=index&a=delete_keywords_category&id=<?php echo $vo['category_id'];?>','确定删除“<?php echo $vo['name'];?>”吗?')">删除</a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
