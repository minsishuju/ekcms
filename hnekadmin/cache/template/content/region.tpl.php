    ...
    <body>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td align='center'><?php echo $vo['region_id'];?></td>
                    <td ><?php echo $vo['name'];?></td>
                    <td ><?php echo $vo['mark'];?></td>
                    <td align='center'>
                        <a href="javascript:void(0)" class="edit_region" data-region_id="<?php echo $vo['region_id'];?>">修改</a>&nbsp;|&nbsp;
                        <a href="javascript:void(0)" onclick="return confirmurl('index.php?c=content&a=delete_region&id=<?php echo $vo['region_id'];?>','确定删除“<?php echo $vo['name'];?>”吗?')">删除</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
