...
<?php include $this->template("public/header"); ?>
    <div class="row-fluid">
        <?php include $this->template("member/left"); ?>
        <div class="right">
            <div class="main">
                <iframe frameborder="0" id="mainFrame" name="mainFrame" src="index.php?c=member&a=lists" style="background: url('<?php echo __PUBLIC__;?>images/loading.gif') center no-repeat"></iframe>
            </div>
        </div>
    </div>
</body>
