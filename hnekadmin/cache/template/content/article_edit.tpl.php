        ...
        KindEditor.ready(function(K) {
            editor = K.create('textarea[name="content"]', {
                ...
                afterCreate : function(){
                    this.html('<?php echo @str_replace(array(chr(13),chr(10)),'',addcslashes($content['content'],'\''));?>');
                }
            });
        });
    </script>
...
<body>
    ...
    <form action="" method="post" class="form-search">
        <input name="content_id" type="hidden" value="<?php echo $content['content_id'];?>">
        <table class="table table-bordered">
            <tbody>
                <tr>
                    <td align="right"><strong>标题：</strong></td>
                    <td>
                        <input type="text" name="title" value="<?php echo @iHtmlSpecialChars($content['title']);?>" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="author" value="<?php echo @iHtmlSpecialChars($content['author']);?>" />
                    </td>
                </tr>
                <tr>
                    <td align="right"><strong>来源：</strong></td>
                    <td>
                        <input type="text" name="copyfrom" value="<?php echo @iHtmlSpecialChars($content['copyfrom']);?>" />
                    </td>
                </tr>
                <tr>
                    <td align="right"><strong>发布时间：</strong></td>
                    <td>
                        <input type="text" name="add_time" class="Wdate" value="<?php echo @date('Y-m-d',$content['add_time']);?>" />
                    </td>
                </tr>
                <tr>
                    <td align="right"><strong>关键字：</strong></td>
                    <td>
                        <textarea name="keywords" placeholder="关键字中间用半角逗号隔开"><?php echo @iHtmlSpecialChars($content['keywords']);?></textarea>
                    </td>
                </tr>
                <tr>
                    <td align="right"><strong>描述：</strong></td>
                    <td>
                        <textarea name="description" placeholder="针对搜索引擎设置的网页描述"><?php echo @iHtmlSpecialChars($content['description']);?></textarea>
                    </td>
                </tr>
                <tr>
                    <td align="right"><strong>封面图片：</strong></td>
                    <td>
                        <?php if ($content['image']) { ?><img width="30" height="30" src="<?php echo $content['image'];?>"><?php } ?><input type="hidden" name="image" id="image" value="<?php echo $content['image'];?>" /> <input type="button" class="btn btn-primary updateimgbutton" data-input_id="image" value="选择图片" />
                    </td>
                </tr>
                        ...
                        <ul class="tags_box">
                            <li>
                                <?php foreach ($vo['tags'] as $val) {?>
                                    <span class="tags <?php if (in_array($val['tags_id'],$content['tags'])) { ?>active<?php } ?>" data-tags="<?php echo $val['tags_id'];?>" <?php if (in_array($val['tags_id'],$content['tags'])) { ?>data-active="1"<?php } ?>><?php echo $val['name'];?></span>
                                    <?php if (in_array($val['tags_id'],$content['tags'])) { ?>
                                    <input type="hidden" value="<?php echo $val['tags_id'];?>" name="tags[]">
                                    <?php } ?>
                                <?php } ?>
                            </li>
                        </ul>
                ...
                <tr>
                    <td align="right"><strong><?php echo $vo['name'];?>：</strong></td>
                    <td>
                        <input type="text" name="data[<?php echo $vo['field'];?>]" value="<?php echo $data[$vo['field']];?>" />
                    </td>
                </tr>
                <?php } ?>
                ...
                <tr>
                    <td align="right"><strong><?php echo $vo['name'];?>：</strong></td>
                    <td>
                        <textarea name="data[<?php echo $vo['field'];?>]"><?php echo $data[$vo['field']];?></textarea>
                    </td>
                </tr>
                <?php } ?>
                ...
                <tr>
                    <td align="right"><strong><?php echo $vo['name'];?>：</strong></td>
                    <td>
                        <?php if ($data[$vo['field']]) { ?><img width="30" height="30" src="<?php echo $data[$vo['field']];?>"><?php } ?><input type="hidden" name="data[<?php echo $vo['field'];?>]" id="image_<?php echo $vo['field'];?>" value="<?php echo $data[$vo['field']];?>" /><input type="button" data-input_id="image_<?php echo $vo['field'];?>" class="btn btn-primary updateimgbutton" value="选择图片" />
                    </td>
                </tr>
                <?php } ?>
                <?php }} ?>
                <tr>
                    ...
                    <td>
                        <textarea name="content" style="width:800px;height:500px;" class="editor"><?php echo @iStripslashes($content['content']);?></textarea>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <ul id="relation_box">
                        <?php foreach ($relation as $vo) {?>
                        <li rel="<?php echo $vo['content_id'];?>">
                            <a title="<?php echo $vo['title'];?>" href="javascript:void(0)"><?php echo $vo['title'];?></a>
                            <input type="hidden" name="ids[]" value="<?php echo $vo['content_id'];?>">
                        </li>
                        <?php } ?>
                        </ul>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <label class="checkbox">
                            <input name="posids[]" type="checkbox" value="<?php echo $vo['posids_id'];?>" <?php if (in_array($vo['posids_id'],$content['posids'])) { ?>checked="checked"<?php } ?>><?php echo $vo['name'];?>
                        </label>
                        <?php } ?>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="right"><strong><?php echo $vo['name'];?>：</strong></td>
                    <td>
                        <textarea name="data[<?php echo $vo['field'];?>]" id="<?php echo $vo['field'];?>" style="width:800px;height:500px;" class="editor"></textarea>
                    </td>
                </tr>
                <script type="text/javascript">
                    var editor_<?php echo $vo['field'];?>;
                    KindEditor.ready(function(K) {
                        editor_<?php echo $vo['field'];?> = K.create('textarea#<?php echo $vo['field'];?>', {
                            uploadJson:'index.php?c=Common&a=editor',
                            allowFileManager : true,
                            fileManagerJson: "index.php?c=Common&a=manager",
                            urlType : '',
                            ...
                            loadStyleMode : false,
                            afterCreate : function(){
                                this.html('<?php echo @str_replace(array(chr(13),chr(10)),'',addcslashes($data[$vo['field']],'\''));?>');
                            }
                        });
                    });
                </script>
