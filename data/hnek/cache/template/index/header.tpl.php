...
<div class="n_top" <?php if (empty($CATEGORYS[$category_id][image])) { ?><?php } else { ?>style="background:url(<?php echo $CATEGORYS[$category_id][image];?>) no-repeat center bottom #2b2b2b;"<?php } ?>>
