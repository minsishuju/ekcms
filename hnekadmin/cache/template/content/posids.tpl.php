    ...
    <body>
        <ul class="breadcrumb">
            ...
            <li class="pull-right" style="margin-top:-3px">
                <a class="btn btn-small btn-primary pull-right" href="javascript:void(0);" id="add_posids">添加推荐位</a>
            </li>
        </ul>
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td align='center'><?php echo $vo['posids_id'];?></td>
                    <td ><?php echo $vo['name'];?></td>
                    <td align='center'>
                        <a href="javascript:void(0)" class="edit_posids" data-posids="<?php echo $vo['posids_id'];?>">修改</a> | 
                        <a href="javascript:void(0)" onclick="return confirmurl('index.php?c=content&a=delete_posids&id=<?php echo $vo['posids_id'];?>','确定删除“<?php echo $vo['name'];?>”吗?')">删除</a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
        ...
        <script>
            $(function(){
                $('#add_posids').click(function(){
                    $('#myModalLabel').html('添加推荐位');
                    $('#posids').modal({
                        remote:'index.php?c=content&a=add_posids'
                    });
                });
                $('.edit_posids').click(function(){
                    $('#myModalLabel').html('修改推荐位');
                    var posids_id = $(this).data('posids');
                    $('#posids').modal({
                        remote:'index.php?c=content&a=edit_posids&id='+posids_id
                    });
                });
